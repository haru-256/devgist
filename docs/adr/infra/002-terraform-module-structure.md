...
- Terraform 構成として、ドメイン駆動モジュールとマルチプロジェクト戦略を採用する。
- 初期フェーズでは Ops / Data / App の責務を分離し、環境ごとに独立した GCP プロジェクトと root module を持つ構成とする。
- 将来、ネットワーク要件や運用体制が変化した場合は、接続方式やモジュール境界を再検討する。
...
* [Module: data_platform](../../../infra/terraform/modules/data_platform/README.md)
* [Module: app_databases](../../../infra/terraform/modules/app_databases/README.md)
