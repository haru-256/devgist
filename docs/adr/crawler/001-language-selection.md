...
- [DBLPRepository](../../../workflows/crawler/src/repositories/dblp_repository.py) - DBLP API連携（不定形データ処理の実例）
- [SemanticScholarRepository](../../../workflows/crawler/src/repositories/semantic_scholar_repository.py) - Semantic Scholar連携
- [ArXivRepository](../../../workflows/crawler/src/repositories/arxiv_repository.py) - arXiv連携（セキュアなXMLパース）
- [UnpaywallRepository](../../../workflows/crawler/src/repositories/unpaywall_repository.py) - Unpaywall連携
- [Paper Model](../../../workflows/crawler/src/models/paper.py) - Pydanticによる型定義
